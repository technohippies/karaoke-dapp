/**
 * Karaoke Scorer Lit Action V20
 * Fixed zero score handling - now correctly returns 0 when performance is bad
 */

console.log('🚀 KARAOKE SCORER V20 STARTING - ZERO SCORE FIX');
...
"I've never seen a diamond in the flesh" → "I never seen a diamond in the flesh" = 95 (missing "'ve")
"I've never seen a diamond in the flesh" → "I've never seen a diamond in flesh" = 90 (missing "the")
"I've never seen a diamond in the flesh" → "I've never seen diamonds in flesh" = 75 (multiple errors)
"I've never seen a diamond in the flesh" → "I've never been a diamond in flash" = 40 (wrong words)
"I've never seen a diamond in the flesh" → "I've seen diamond" = 30 (major omissions)
"I've never seen a diamond in the flesh" → "what" = 0 (single unrelated word)
"I've never seen a diamond in the flesh" → "testing testing one two three" = 0 (completely unrelated)
"I've never seen a diamond in the flesh" → "junk" = 0 (single unrelated word)
