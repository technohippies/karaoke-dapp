...
// Lit Action CIDs
export const VOICE_GRADER_CID = process.env.VOICE_GRADER_CID || 'QmYov82aEgcqq1kMaYCoDQzH79PW8Q2pfLiddA96MRTdyX' // Nova-3 with auto-detect content type
export const SESSION_SETTLEMENT_CID = process.env.SESSION_SETTLEMENT_CID || 'QmTWKXSkmo3xDjmWCb3wvQhY5zL49KQwkzSryJUE35SZNd' // Debug version for testing
