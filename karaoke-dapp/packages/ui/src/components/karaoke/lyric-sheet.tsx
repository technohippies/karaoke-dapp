  ...
  return (
    <Sheet>
      ...
      <SheetContent
        ...
        style={{ height: '95vh', maxHeight: '700px' }}
      >
        <div
                  ...
                  >
                    ...
                    <div className="mt-2 space-y-1">
                      ...
                      <div
                        ...
                        style={{
                          visibility: generatedContent[section.id]
                            ? 'visible'
                            : 'hidden',
                        }}
                      >
                        {section.id === 'grammar' ? (
                          ...
                          <p>
                            {generatedContent[section.id] ||
                              'placeholder text that takes up space'}
                          </p>
                        )}
                      </div>
                    </div>
            ...
            <Button
              ...
              onClick={() => {
                ...
                setGeneratedContent({
                  ...
                  meaning:
                    '这句歌词用诗意的比喻表达永恒的爱情。歌手承诺他们的爱会持续到一个不可能发生的事件，暗示爱是无尽的。',
                  grammar:
